...
static NSBundle *_iOSREHookerTweakWeeAppBundle = nil;

@interface iOSREHookerTweakController: NSObject <BBWeeAppController> {
	UIView *_view;
...
@implementation iOSREHookerTweakController
@synthesize view = _view;

+ (void)initialize {
	_iOSREHookerTweakWeeAppBundle = [[NSBundle bundleForClass:[self class]] retain];
}
